...
const DETECTOR_REGLAS = [
  ...
  // ═══════════════════════════════════════
  {
    ...
    palabras: ['inf-01', 'ejecución presupuestal de ingresos', 'ejecucion presupuestal de ingresos', 'ejecución de ingresos', 'ejecucion de ingresos', 'ejec_ingresos', 'ejec ingresos', '01_ejec_ingresos', 'ingresos recaudados', 'recursos del balance', 'recursos sgp', 'transferencias nacionales gratuidad'],
    peso: 5
  },
  {
    tipo: 'inf_ejec_egresos',
    nombre: 'Ejecución Presupuestal de Egresos',
    palabras: ['inf-02', 'ejecución presupuestal de egresos', 'ejecucion presupuestal de egresos', 'ejecución de egresos', 'ejecucion de egresos', 'ejec_egresos', 'ejec egresos', '02_ejec_egresos', 'egresos comprometidos', 'pagos efectuados', 'gastos por rubro'],
    peso: 5
  },
  {
    tipo: 'inf_pac_ejecutado',
    nombre: 'PAC Ejecutado',
    palabras: ['inf-03', 'pac ejecutado', 'pac_ejecutado', '03_pac_ejecutado', 'programa anual mensualizado de caja ejecutado', 'pac ejecucion', 'pac ejecución'],
    peso: 5
  },
  {
    tipo: 'inf_relacion_gastos',
    nombre: 'Relación de Gastos',
    palabras: ['inf-04', 'relación de gastos', 'relacion de gastos', 'relacion_gastos', '10_relacion_gastos', 'detalle de gastos', 'consolidado de gastos'],
    peso: 5
  },
  {
    tipo: 'inf_cierre_anual',
    nombre: 'Cierre Presupuestal Anual',
    palabras: ['inf-05', 'cierre presupuestal anual', 'cierre presupuestal', 'cierre anual', 'cierre_2026anual', 'cierre fiscal', 'cierre vigencia', 'reservas presupuestales', 'cuentas por pagar al cierre'],
    peso: 5
  },
  {
    tipo: 'inf_contraloria',
    nombre: 'Reporte Contraloría',
    palabras: ['inf-06', 'reporte contraloría', 'reporte contraloria', 'contraloria_2026anual', 'informe a contraloría', 'informe a contraloria', 'sirec', 'sireci'],
    peso: 5
  },
  {
    tipo: 'inf_pac_anual',
    nombre: 'PAC Anual',
    palabras: ['inf-07', 'pac anual', 'pac_2026anual', 'programa anual mensualizado de caja', 'pac programación', 'pac programacion'],
    peso: 5
  },
  {
  ...
  },
  {
    ...
    palabras: ['pag-04', 'soporte de pago', 'soporte pago bancario', 'comprobante de pago', 'comprobante bancario', 'transferencia bancaria', 'transferencia electronica', 'transferencia electrónica', 'consignacion bancaria', 'consignación bancaria', 'recibo de pago', 'recibo bancario', 'transaccion exitosa', 'transacción exitosa', 'pago realizado', 'pago efectuado', 'pse', 'transferencia ach', 'orden de transferencia', 'cuenta destino', 'cuenta beneficiario', 'pago contratista', 'codigo de aprobacion', 'código de aprobación', 'numero de transaccion', 'número de transacción', 'comprobante de transferencia', 'soporte transferencia', 'nóminas, proveedores y libranzas', 'nominas, proveedores y libranzas', 'nominas proveedores y libranzas', 'no. autorización', 'no. autorizacion', 'valor a pagar', 'fecha de emisión', 'fecha de emision', 'fecha de pago', 'estado en proceso', 'verifique el débito', 'verifique el debito', 'detalle de: resultado', 'producto destino', 'entidad financiera', 'banco de bogotá', 'banco de bogota', 'bancolombia', 'davivienda', 'banco popular', 'bbva', 'banco av villas', 'banco caja social', 'banco agrario', 'colpatria', 'scotiabank', 'producto origen', 'tipo producto', 'no. producto', 'cuenta corriente', 'cuenta ahorros', 'beneficiario', 'tipo identificación', 'tipo identificacion', 'referencia / no. factura', 'tipo pago'],
    peso: 5
  },
  {
    tipo: 'acuerdo_consejo',
    nombre: 'Acuerdo del Consejo Directivo / Aprobación',
    palabras: ['pre-14', 'acuerdo del consejo directivo', 'acuerdo consejo directivo', 'aprobación del consejo directivo', 'aprobacion del consejo directivo', 'acuerdo de aprobación', 'acuerdo de aprobacion', 'sesión del consejo directivo', 'sesion del consejo directivo', 'aprueba la contratación', 'aprueba la contratacion', 'autoriza la contratación', 'autoriza la contratacion'],
    peso: 5
  },
  {
