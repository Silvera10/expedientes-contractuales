  ...
  try {
    ...
    if(files.length > 1){
      ...
      const MAPA_NOMBRES = [
        ...
        { pats: ['condiciones generales poliza', 'condiciones generales de la poliza', 'condiciones generales de la póliza', 'condiciones generales póliza', 'clausulado poliza', 'clausulado póliza', 'condicionado poliza', 'condicionado póliza', 'clausulas generales poliza', 'cláusulas generales póliza'], tipo: 'condiciones_poliza' },
        { pats: ['poliza cumplimiento', 'póliza cumplimiento', 'poliza de cumplimiento', 'póliza de cumplimiento', 'garantia cumplimiento', 'garantía cumplimiento', 'garantia de cumplimiento', 'garantía de cumplimiento', 'poliza calidad', 'póliza calidad', 'poliza salarios prestaciones', 'póliza salarios prestaciones', 'poliza responsabilidad civil', 'póliza responsabilidad civil', 'garantia unica', 'garantía única', 'poliza n', 'póliza n', 'poliza no', 'póliza no', 'certificado poliza', 'certificado póliza', 'seguros del estado poliza', 'previsora poliza', 'suramericana poliza', 'aseguradora solidaria poliza'], tipo: 'poliza' },
