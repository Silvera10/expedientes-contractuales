...
const DETECTOR_REGLAS = [
  ...
  },
  {
    ...
    palabras: ['pre-13', 'acta de cierre del proceso', 'acta cierre del proceso', 'cierre del proceso de seleccion', 'cierre del proceso de selección', 'cierre proceso de seleccion', 'cierre proceso de selección', 'cierre del plazo de cotizaciones', 'cierre recepcion de ofertas', 'cierre recepción de ofertas', 'cierre de invitacion', 'cierre de invitación', 'cierre publico de ofertas', 'cierre público de ofertas', 'acta de apertura y cierre', 'numero de oferentes recibidos', 'número de oferentes recibidos'],
    peso: 5
  },
